    ...
    <div className="w-full max-w-2xl">
      ...
      >
        <CardHeader className="text-center space-y-2">
          ...
          >
            Automated Liquidation Agent using vincent
          </CardDescription>
        </CardHeader>
        ...
        <CardContent className="space-y-5">
          ...
          >
            Secure and verifiable Liquidation Agent on Equiblock.
          </p>
          ...
          >
            This application allows you to monitor users who deposit collateral in equiblock and
            liquidate positions when they become under-collateralized.
          </p>
          ...
          >
            To get started, connect with Vincent to start monitoring users positions.
          </p>
        </CardContent>
